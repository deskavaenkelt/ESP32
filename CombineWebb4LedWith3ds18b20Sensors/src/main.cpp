...
void setButtonColor()
{
	...
	{
		client.println(".button { background-color: #FF0000; border: 2px solid #4CAF50;; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; }");
	}
	else
	{
			...
			if (client.available())
			{
				...
				if (new_byte == '\n')
				{
					...
					if (current_data_line.length() == 0)
					{
						...
						client.println("<center><h3>with additions for sensordata</h3></center>");
						...
						client.print("<p>Sensor0 is ");
						client.print(valueOfSensor0);
						client.println(" C</p>");
						client.print("<p>Sensor1 is ");
						client.print(valueOfSensor1);
						client.println(" C</p>");
						client.print("<p>Sensor2 is ");
						client.print(valueOfSensor2);
						client.println(" C</p>");

						readDataFromEsp();
						client.println("<h2>Onbord sensor data from ESP32 is:</h2>");
						client.print("<p>Temperature value is ");
						client.print(espTemperature);
						client.println(" C</p>");
						client.print("<p>Hall sensor value is ");
						client.print(espHallSensorValue);
						client.println(" </p>");
